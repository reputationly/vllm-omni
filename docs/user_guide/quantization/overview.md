...
| Int8 W8A8 | [Int8](int8.md) | Online or serialized W8A8 | Qwen-Image, Z-Image, MiniMax H3; Wan2.2 is not validated | Validated for Qwen-Image and Z-Image; MiniMax H3 uses its offline partition quantizer and keeps sensitive layers in BF16 |
