...
class Ideogram4FinalLayer(nn.Module):
    ...
    def __init__(
        ...
        # Final velocity-prediction head: on-disk checkpoint stores this in full
        # precision (its weight shape doesn't match a packed-4bit buffer, unlike
        # every other Linear in this transformer) — small, precision-sensitive
        # output projection, kept unquantized same as an LLM's lm_head.
