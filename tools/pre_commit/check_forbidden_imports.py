...
CHECK_IMPORTS = {
    ...
    "base64": ForbiddenImport(
        ...
        allowed_files={
            ...
            "vllm_omni/model_executor/models/minicpmo_4_5/duplex/adapter.py",
            "vllm_omni/model_executor/models/minicpmo_4_5/duplex/input.py",
            "vllm_omni/model_executor/models/minicpmo_4_5/duplex/runtime.py",
            "vllm_omni/model_executor/models/minicpmo_4_5/duplex/stage0.py",
            "vllm_omni/entrypoints/duplex/audio.py",
            "vllm_omni/entrypoints/duplex/realtime_input.py",
